...
PoolRecHybridInh::~PoolRecHybridInh() 
{
//	delete V;
//	delete ISyn;
//    delete ISynBG;
...
//        ITot += -VAvgE *1000* gext_AMPA * 67.8;
...
void PoolRecHybridInh::propogate()
{	
    // Empty because this type of pool does not spike!
}

void PoolRecHybridInh::updateS()
{
...
void PoolRecHybridInh::connectTo(PoolBG &BGPool_in)
{
	BG_Inputs_AMPA->push_back(BGPool_in.AMPA);
}

void PoolRecHybridInh::connectTo(PoolRecEx &ExPool_in, double wIn)
{
