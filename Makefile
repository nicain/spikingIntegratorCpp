...
RELEASEFLAGS=
SOURCES=spikingIntegrator.cpp Brain.cpp Pool.cpp SpikeList.cpp PoolBG.cpp PoolBGFile.cpp PoolRec.cpp PoolRecEx.cpp PoolRecInh.cpp Monitor.cpp MonitorNeuron.cpp MonitorNeuronFile.cpp
