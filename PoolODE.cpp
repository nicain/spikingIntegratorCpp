...
void PoolODE::run3(PoolPoisson &I1, PoolPoisson &IBG1, PoolPoisson &I2, PoolPoisson &IBG2,PoolPoisson &INS,PoolPoisson &INH)
{
	T = 1;
	for ( t=dt; t <= tmax; t = t + dt)
	{
		X1[T-1] = JAin*I1.spks[T-1] + JAbg*IBG1.spks[T-1] + JAbg*INS.spks[T-1] - JAbg*INH.spks[T-1] + Jii*S1[T-1] + Jij*S2[T-1];
		X2[T-1] = JAin*I2.spks[T-1] + JAbg*IBG2.spks[T-1] + JAbg*INS.spks[T-1] - JAbg*INH.spks[T-1] + Jii*S2[T-1] + Jij*S1[T-1];
