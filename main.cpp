...
//	PoolPoisson I1("I2",Network,N,0,5*N,0,0,tOff,tMax);
//	PoolPoisson I2("I2",Network,N,0,5*N,0,0,tOff,tMax);
//	PoolPoisson IC("IC",Network,N,0,5*N,0,0,tOff,tMax);
	
	// ODE system
	PoolODE ODE("ODE",Network,tMax,a,b,c,JNii,JNij,JAij,JAext,JAext,tau,gamma,I0);
	//PolkODE ODE("ODE",Network,tMax,5,80E-3,15,atof(argv[5]),atof(argv[3]),atof(argv[4]));
