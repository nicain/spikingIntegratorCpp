#ifndef POOLRECHYBRIDEX_H
#define POOLRECHYBRIDEX_H
...
class PoolRecHybridEx: public Pool
{	
  ...
  public:
	...
	PoolRecHybridEx(string, Brain&, int);
	PoolRecHybridEx(string, Brain&, int, bool);
	void construct();
	~PoolRecHybridEx();
...
//	valarray<bool> *thresholdTest;
	...
	void connectTo(PoolRecHybridEx &ExPool_in, double wIn);
	void init();	
	void updateV();
	void propogate();
	void updateS();
